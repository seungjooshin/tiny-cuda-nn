...
class Encoding(Module):
	...
	def __init__(self, n_input_dims, encoding_config, seed=1337, dtype=None):
		...
		if 'interpolation' in encoding_config.keys():
			...
			self.binary = True if (interpolation == 'BinaryLinear' or interpolation == 'BinaryLinearApprox' or interpolation == 'BinaryNearest' or interpolation == 'BinaryNearestWeighted') else False
